...
<body>
	...
	<div style="margin:0px auto;" class="keleyitable"><h2>留言列表</h2>
		<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><table>
				<tr><td class = klytd>留言人：</td><td class = hvttd><?php echo ($vo["username"]); ?></td></tr>
				<tr><td class = klytd>电话号码：</td><td class = hvttd><?php echo ($vo["telephone"]); ?></td></tr>
				<tr><td class = klytd>电子邮箱：</td><td class = hvttd><?php echo ($vo["email"]); ?></td></tr>
				<tr><td class = klytd>内容：</td><td class = hvttd><?php echo ($vo["message"]); ?></td></tr>
				<tr><td class = klytd>内容性质：</td><td class = hvttd><?php echo ($vo["messagetype"]); ?></td></tr>
				<tr><td class = klytd>日期：</td><td class = hvttd><?php echo ($vo["addtime"]); ?></td></tr>
				<tr><td class = klytd>ip地址：</td><td class = hvttd><?php echo ($vo["addip"]); ?></td></tr>
