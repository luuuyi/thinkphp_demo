...
<head>
	...
	<link rel="stylesheet" type="text/css" href="/testbench/tp/Public/Home/css/bootstrap.min.css" />
	<link rel="stylesheet" type="text/css" href="/testbench/tp/Public/Home/css/style.css" />

    
	<script src="/testbench/tp/Public/Home/js/jquery-2.2.4.min.js" type="text/javascript"></script>
...
<body>
	...
	<div class="login_div">
		...
		<form action="/testbench/tp/index.php/Home/User/login" class="login" method="post">
			<div class="nav">
	...
	<div class="register_body">
		...
		<form action="/testbench/tp/index.php/Home/User/register" class="register" method="post">
			<div class="nav">
				<div class="nav register_nav">
					...
					<div class="col-xs-6">
						<input type="text" name="name_register" id="name_r" value="" placeholder="&nbsp;&nbsp;用户名/手机号" onBlur="javascript:ok_or_errorByRegister(this)" />
					</div>
					<div class="col-xs-1 ok_gou">
						√
					</div>
				...
				<div class="nav register_psdnav">
					...
					<div class="col-xs-6">
						<input type="password" name="passwd_register" id="psd_r" value="" placeholder="&nbsp;&nbsp;密码" onBlur="javascript:ok_or_errorByRegister(this)" />
					</div>
					<div class="col-xs-1 ok_gou">
						√
					</div>
