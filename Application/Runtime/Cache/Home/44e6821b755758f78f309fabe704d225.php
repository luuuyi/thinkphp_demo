...
<body>
	      ...
	      <ul class="nav navbar-nav">
	         ...
	         <li class="dropdown active">
	            ...
	            <ul class="dropdown-menu">
	               <li  class="active"><a href="/testbench/tp/index.php/Home/User/uploadFile">上传文件</a></li>
    ...
    <form action="/testbench/tp/index.php/Home/User/uploadFile" method="post" class="basic-grey" enctype="multipart/form-data">
    	<h1>Contact Form
    		<span>Please fill all the texts in the fields.</span>
    	</h1>
    	<label>
	    	<span>Notes :</span>
	    	<textarea id="message" name="notes" placeholder="Your Message to This File"></textarea>
	    </label>
