...
function creatForm(formMethod, formAction){
	$.post("/testbench/tp/index.php/TPH/FCode/creatForm", {'formMethod' : formMethod, 'formAction' : formAction},
		function(data){
...
function loadField(){
	...
	$.post("/testbench/tp/index.php/TPH/FCode/loadField",{'tableName': tableName},
	function(data){
